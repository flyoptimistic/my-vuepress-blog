---
title: 并发系列(四)：JVM 内置锁 synchronized 关键字详解
order: 4
date: 2023-03-01
category:
  - Java
...
tag:
  ...
  - Monitor
  - 线程安全
description: synchronized 原理、对象头、Monitor 和锁升级机制学习笔记。
---
## 设计同步器的意义
...
![0](/images/legacy/concurrent-synchronized/synchronized底层原理.png)

每个同步对象都有一个自己的Monitor(监视器锁)，加锁过程如下图所示：

    ![0](/images/legacy/concurrent-synchronized/monitor.png)
...
反编译结果：
    ...
    ![0](/images/legacy/concurrent-synchronized/14066.png)
...
- 对齐填充：由于虚拟机要求 **对象起始地址必须是8字节的整数倍**。填充数据不是必须存在的，仅仅是为了字节对齐；
    ...
    ![0](/images/legacy/concurrent-synchronized/对象的内存布局.png)
...
![image-20230216105344313](/images/legacy/concurrent-synchronized/32位对象头.png)

64位虚拟机

    ![0](/images/legacy/concurrent-synchronized/14098.png)
...
<!-- 旧文图片未随 Hexo 项目归档: synchronized锁实现与升级过程.png -->
