...
tag:
  ...
  - 缓存一致性
  - 并发
description: CPU 高速缓存、局部性原理和 MESI 缓存一致性协议整理。
---
...
4. 高速缓存中的数据写回主内存
       ...
       ![1](/images/legacy/concurrent-mesi/高速缓存1.png)
...
**多级缓存结构**
    ...
    ![0](/images/legacy/concurrent-mesi/高速缓存2.png)
...
![0](/images/legacy/concurrent-mesi/MESI状态转换.png)
...
![0](/images/legacy/concurrent-mesi/14506.png)
...
![0](/images/legacy/concurrent-mesi/14510.png)
...
![0](/images/legacy/concurrent-mesi/14509.png)
...
![0](/images/legacy/concurrent-mesi/14511.png)
...
![0](/images/legacy/concurrent-mesi/14508.png)
...
1. 第一、就是处理器会尝试从存储缓存（Store buffer）中读取值，但它还没有进行提交。这个的解决方案称为Store Forwarding，它使得加载的时候，如果存储缓存中存在，则进行返回。
