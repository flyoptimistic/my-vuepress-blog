...
tag:
  ...
  - ReentrantLock
  - 并发
description: AQS 基础、ReentrantLock、公平锁和非公平锁实现原理。
---
## AQS应用之Lock

### 并发之父

[Doug Lea](https://baike.baidu.com/item/Doug%20Lea/6319404?fr=aladdin)(小名：李二狗)
...
AQS当中的同步等待队列也称CLH队列，CLH队列是Craig、Landin、Hagersten三人发明的一种基于双向链表数据结构的队列，是FIFO先入先出线程等待队列，Java中的CLH队列是原CLH队列的一个变种,线程由原自旋机制改为阻塞机制。
    ...
    ![0](/images/legacy/concurrent-aqs-lock/14090.png)

### 条件等待队列

Condition是一个多线程间协调通信的工具类，使得某个，或者某些线程一起等待某个条件（Condition）,只有当该条件具备时，这些等待线程才会被唤醒，从而重新争夺锁

    ![0](/images/legacy/concurrent-aqs-lock/14092.png)
