---
title: 并发系列(六)：AQS 应用之 BlockingQueue 详解
order: 6
date: 2023-03-01
category:
  - Java
...
tag:
  ...
  - 阻塞队列
  - 并发
description: 阻塞队列类型、数据结构和生产者消费者场景学习笔记。
---
## 概要
...
- 主要操作：入队（EnQueue）与出队（Dequeue）
    ...
    ![0](/images/legacy/concurrent-blocking-queue/15836.png)
...
数据结构如下图：
    ...
    ![0](/images/legacy/concurrent-blocking-queue/15837.png)
