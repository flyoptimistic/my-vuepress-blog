---
title: 并发系列(十)：Executor 线程池原理与源码解读
order: 10
date: 2023-03-01
category:
  - Java
...
tag:
  ...
  - ThreadPoolExecutor
  - 源码
description: Java 线程池、Executor 框架和 ThreadPoolExecutor 源码学习笔记。
---
## 线程
...
状态切换如下图所示：
    ...
    ![0](/images/legacy/concurrent-executor/16280.png)
...
下图为它的继承与实现
    ...
    ![0](/images/legacy/concurrent-executor/3298.png)
...
- 线程池存在5种状态
  ...
  - 设置TIDYING状态成功。
      ...
      ![0](/images/legacy/concurrent-executor/3965.png)
...
### 线程池原理
    ...
    ![0](/images/legacy/concurrent-executor/3420.png)
...
execute方法执行流程如下：
    ...
    ![0](/images/legacy/concurrent-executor/4013.png)
...
至此，processWorkerExit执行完之后，工作线程被销毁，以上就是整个工作线程的生命周期，从execute方法开始，Worker使用ThreadFactory创建新的工作线程，runWorker通过getTask获取任务，然后执行任务，如果getTask返回null，进入processWorkerExit方法，整个线程结束，如图所示：
    ...
    ![0](/images/legacy/concurrent-executor/4068.png)
